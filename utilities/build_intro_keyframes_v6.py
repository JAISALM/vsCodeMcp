...
CHAR_REF = "intro_char_ref_bw.png"  # node 72 = FULL character ref (face+body+shirt) - V6 identity fix (face-crop broke identity)
...
CHAR = ("A single bare bulb hangs from above on a thin cord, the ONLY light "
        ...
        "wavy hair, dark complexion, wearing a black full-sleeve shirt that is "
...
for name, (char_ref, scene_ref, ref_boost, ref_boost_a, instr) in KFS.items():
    ...
    out = WF_DIR / f"krea2_intro_{name}_v6.json"
