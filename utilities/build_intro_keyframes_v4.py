...
KFS = {
    ...
    "kf2_seated": (
        ...
        BW + CHAR + "sits in the wooden chair at the table, centered, facing "
        "the camera directly, calm and composed. " + ONE_CHAIR + " " + CAM +
...
for name, (char_ref, scene_ref, ref_boost, ref_boost_a, instr) in KFS.items():
    ...
    out = WF_DIR / f"krea2_intro_{name}_v4.json"
